...
/* tty_newline move cursor to the beginning of the next line, clearing to the end of the current line */
void tty_newline(tty_t *tty);

/* tty_clearline clear to the end of the current line without advancing the cursor. */
